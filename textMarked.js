    ...
    $.widget('ds.marker', {
        ...
        _create: function() {
            ...
            var that_mouseup = function that_mouseup(e) {
                ...
                if (kc === 1) {
                    e.preventDefault();
                    var block, range, tempRange, before = '',
                        after = '';
                    if (window.getSelection) {
                        ...
                        tempRange.insertNode(document.createTextNode(mark)); /*after = tempRange.toString();*/
                        tempRange.detach();
                        ...
                        tempRange.moveToElementText(_this);
                        tempRange.setEndPoint('StartToEnd', range); /*after = tempRange.text;*/
                    }
        ...
        restore: function(data) {
            ...
            _that.element.html(htmlArrJoin); /* str에서 n번째 출연한 find의 위치 */
        ...
        _validatemarker: function(range, e) {
            ...
            if (val && _that._getParentNode(range).className.indexOf(class_default) > -1 && _that.options.overlap == false) {
                _that._deselection();
                if (_that.options.debug) {
                    message = 'Set the "overlap" option to "true" if you want to set overlap marker.';
                }
                val = false;
